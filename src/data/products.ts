...
export const openSourceProducts: Product[] = [
  {
    ...
    company: 'zhayujie',
    category: ['开源项目', '免费'],
    description: '基于大模型的超级AI助理，支持微信、飞书、钉钉等多平台接入，比OpenClaw更轻量便捷',
    url: 'https://github.com/zhayujie/chatgpt-on-wechat',
    tags: ['微信机器人', 'AI助理', '多平台', 'LLM集成'],
  ...
  },
  {
    ...
    tags: ['AI工作室', '聊天助手', '多LLM支持', '智能体'],
    stars: { difficulty: 3, customizability: 8, speed: 7, security: 8 },
    image: '',
  },
  {
    ...
    company: 'Pydantic',
    category: ['开源项目', '免费'],
    description: 'AI Agent Framework, the Pydantic way - Python type-safe AI Agent开发框架',
    url: 'https://github.com/pydantic/pydantic-ai',
    tags: ['Python', 'AI Agent框架', '类型安全', 'Pydantic'],
    stars: { difficulty: 4, customizability: 8, speed: 7, security: 9 },
    image: '',
  },
  {
